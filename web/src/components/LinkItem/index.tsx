    ...
    return(
        <div className="w-full flex icems-center justify-between pb-3 border-b border-gray-200 lg:pb-4">
            <div className="w-1/2 flex flex-col gap-1 items-start overflow-hidden white-space: nowrap lg:flex-1">
                <span className="text-sm text-blue-base truncate font-semibold sm:max-w-[157px] max-w-full">brev.ly/Portfolio-Dev</span>
                <span className="text-xs text-gray-500 truncate sm:max-w-[157px] max-w-full">devsite.portfolio.com.br/devname-123456</span>
            </div>
            <div className="w-1/2 flex items-center justify-end gap-4 lg:gap-5 lg:w-auto">
                <span className="text-gray-500 text-xs">30 acessos</span>
